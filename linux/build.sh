...
core=(src/Core.cs src/CameraSettings.cs src/Updates.cs src/KoreanPack.cs src/HitFont.cs linux/Platform.cs)
...
tar -czf out/AionCL-Launcher-2.5.42-linux-preview.3.tar.gz -C "$out" AionCL.Launcher.Linux.exe launcher.json aioncl-launcher LINUX.md
(cd out && sha256sum AionCL-Launcher-2.5.42-linux-preview.3.tar.gz > AionCL-Launcher-2.5.42-linux-preview.3.tar.gz.sha256)
cat out/AionCL-Launcher-2.5.42-linux-preview.3.tar.gz.sha256
