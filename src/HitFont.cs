...
public sealed class HitFont {
    ...
    string Target(string root,string language) { if(language!="FRA"&&language!="ENG"&&language!="DEU"&&language!="RUS")throw new InvalidDataException("Unsupported language.");return Safety.Under(root,"L10N/"+GameLanguage.Runtime(language)+"/textures/ui/hit_number.pak"); }
